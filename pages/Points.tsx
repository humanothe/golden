      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-8 pb-32">
        ...
        <div className="flex justify-center mb-10">
            <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                <div className="text-center">
                    <span className="block text-4xl font-heading font-bold text-gray-900 dark:text-white">{Math.round(currentPoints)}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className={`glass-panel p-5 rounded-3xl bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/5 flex gap-4 items-center ${currentPoints < 1000 ? 'opacity-60 grayscale' : ''}`}>
                ...
                {currentPoints >= 1000 ? (
                    <button className="ml-auto px-4 py-2 bg-gray-900 dark:bg-white text-white dark:text-black text-[10px] font-bold uppercase rounded-full tracking-wider">Canjear</button>
                ) : (
