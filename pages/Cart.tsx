...
export const Cart: React.FC = () => {
      ...
      return (
          <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-white dark:bg-black">
              ...
              <button 
                ...
                className="px-10 py-4 border border-black dark:border-white text-black dark:text-white font-bold uppercase tracking-[0.2em] hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all"
              >
                  Explorar Market
              </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-light-50 dark:bg-black text-black dark:text-white pb-32">
      
      {/* Header */}
      <div className="sticky top-0 z-40 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-gray-200 dark:border-white/10 px-6 py-4 flex items-center justify-between">
            ...
            <span className="font-mono text-sm font-bold text-gold-600 dark:text-gold-400">{items.reduce((acc, i) => acc + i.quantity, 0)} ITEMS</span>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
            ...
            {/* 1. Items */}
            <section>
                <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-gray-400 mb-6 border-b border-gray-200 dark:border-white/10 pb-2">1. Tu Selección</h2>
                        ...
                        <div key={item.id} className="flex gap-4 group">
                            ...
                            <div className="flex-1 flex flex-col justify-between py-1">
                                ...
                                <div className="flex justify-between items-end">
                                    <div className="flex items-center gap-4 border border-gray-200 dark:border-white/10 px-2 py-1">
            ...
            {/* 2. Delivery */}
            <section>
                <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-gray-400 mb-6 border-b border-gray-200 dark:border-white/10 pb-2">2. Entrega</h2>
                
                <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 p-4 mb-4 flex items-center gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div 
                        ...
                        className={`p-4 border cursor-pointer transition-all flex items-start gap-3 ${deliveryMethod === 'express' ? 'border-gold-400 bg-gold-400/5' : 'border-gray-200 dark:border-white/10'}`}
                    >
                    ...
                    <div 
                        ...
                        className={`p-4 border cursor-pointer transition-all flex items-start gap-3 ${deliveryMethod === 'standard' ? 'border-gold-400 bg-gold-400/5' : 'border-gray-200 dark:border-white/10'}`}
                    >
            ...
            {/* 3. Payment */}
            <section>
                <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-gray-400 mb-6 border-b border-gray-200 dark:border-white/10 pb-2">3. Pago</h2>
                
                <div className="space-y-3">
                    <div 
                        onClick={() => setPaymentMethod('balance')}
                        className={`p-4 border flex items-center justify-between cursor-pointer transition-all ${paymentMethod === 'balance' ? 'border-gold-400 bg-gold-400/5' : 'border-gray-200 dark:border-white/10'}`}
                    >
                    ...
                    <div 
                        ...
                        className={`p-4 border flex items-center justify-between cursor-pointer transition-all ${paymentMethod === 'card' ? 'border-gold-400 bg-gold-400/5' : 'border-gray-200 dark:border-white/10'}`}
                    >
                        <div className="flex items-center gap-3">
        ...
        <div className="lg:col-span-1">
            <div className="sticky top-24 bg-gray-50 dark:bg-white/5 p-6 md:p-8 space-y-6">
                ...
                <button 
                    ...
                    className="w-full py-4 bg-black dark:bg-white text-white dark:text-black font-bold uppercase tracking-[0.2em] hover:bg-gold-400 dark:hover:bg-gold-400 hover:text-black transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2 group"
                >
                    {isProcessing ? (
