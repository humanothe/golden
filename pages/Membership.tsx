...
export const Membership: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] dark:bg-obsidian text-gray-900 dark:text-platinum pb-32 animate-fade-in">
       <header className="pt-8 px-6 pb-6 flex items-center gap-4 border-b border-gray-100 dark:border-white/5 max-w-5xl mx-auto">
          <button onClick={() => navigate('/profile')} className="p-2 bg-gray-100 dark:bg-white/5 rounded-full text-gray-500">
              <ArrowLeft size={20} />
          </button>
          <div>
              <p className="text-[10px] text-gold-600 dark:text-gold-400 font-bold uppercase tracking-widest mb-0.5">Identidad Golden</p>
              <h1 className="font-heading text-xl text-gray-900 dark:text-white">Mi Credencial de Socio</h1>
          </div>
      </header>
      ...
      <div className="p-6 max-w-2xl mx-auto">
          ...
          <div className="relative group mx-auto w-full max-w-[420px]">
              ...
              <div className="relative aspect-[1.586] w-full bg-gradient-to-br from-[#1a1a1a] via-black to-[#050505] rounded-[1.5rem] border border-white/10 overflow-hidden shadow-2xl flex flex-col justify-between p-6">
                  ...
                  <div className="flex justify-between items-start relative z-10">
                      ...
                      <div className="text-right">
                          ...
                          <div className="flex items-center gap-1 justify-end mt-1">
                              ...
                              <span className="text-[8px] text-white/50 uppercase font-bold tracking-widest">Active Member</span>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="relative z-10">
                      ...
                      <div className="flex justify-between items-end">
                          <div>
                              ...
                              <p className="text-[7px] text-white/30 uppercase tracking-[0.2em] mt-0.5">EST. OCT 2024</p>
                          </div>
                          <div className="w-10 h-10 border border-gold-400/30 rounded-lg flex items-center justify-center bg-white/5 backdrop-blur-sm">
          ...
          <div className="mt-12 space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                  ...
                  {user?.membership_tier === 'entry' && (
                    <div className="p-5 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 flex items-center gap-4">
