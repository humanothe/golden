...
export const Wallet: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-black dark:text-white font-sans pb-40 overflow-x-hidden text-left selection:bg-gold-400 relative">
      ...
      <div className={`relative z-10 transition-all duration-1000 ${(appStatus !== 'idle' || successMsg) ? 'blur-3xl scale-95 opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <header className="pt-[env(safe-area-inset-top)] px-6 md:px-12 border-b border-white/10 sticky top-0 z-40 bg-black mb-12">
            <div className="max-w-xl mx-auto pb-6 pt-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate('/dashboard')} className="p-2 -ml-2 text-white/50 hover:text-white active:scale-90 transition-all">
                        <ArrowLeft size={24} strokeWidth={1.5} />
                    </button>
                    <div>
                        <p className="text-[8px] text-gold-400 font-black uppercase tracking-[0.5em] mb-1 opacity-60">RECARGA_DE_ACTIVOS</p>
                        <h1 className="text-xl font-heading font-black tracking-tighter text-white uppercase leading-none">
                            GOLDEN <span className="text-gold-metallic">PUNTOS</span>
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <div className="mb-20 space-y-16">
          <div className="space-y-6 hidden">
            <div className="flex items-center gap-3 opacity-30">
              ...
              <span className="text-[7px] font-black uppercase tracking-[0.4em] text-black dark:text-white">RECARGA_DE_ACTIVOS</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-black dark:text-white uppercase leading-[0.85]">
          ...
          <div className="relative group">
            ...
            <div className="p-10 md:p-14 bg-white/[0.01] border border-black/5 dark:border-white/5 relative overflow-hidden rounded-none">
              <div className="absolute top-0 right-0 p-6 opacity-[0.01] pointer-events-none">
                <ShieldCheck size={140} strokeWidth={0.5} />
              </div>
              <p className="text-[7px] text-black/20 dark:text-white/20 uppercase tracking-[0.5em] mb-10 font-black">CAPITAL_GP_DISPONIBLE</p>
              <div className="flex flex-col items-start">
                <h2 className="text-7xl md:text-9xl font-black tracking-tighter text-black dark:text-white leading-none font-mono">
                ...
                <div className="flex items-center gap-3 mt-8 opacity-40">
                  ...
                  <span className="text-[8px] font-black text-black dark:text-white uppercase tracking-[0.4em]">Sincronizado con Nodo Maestro</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            <button 
              onClick={startCamera} 
              className="group relative p-8 bg-gold-400 hover:bg-black dark:hover:bg-black dark:bg-white text-white dark:text-black transition-all duration-500 active:scale-[0.98] overflow-hidden rounded-none shadow-2xl"
            >
            ...
            <button 
              ...
              className="group relative p-8 bg-white/[0.01] border border-black/5 dark:border-white/5 hover:border-black/10 dark:border-white/10 text-black dark:text-white transition-all duration-500 active:scale-[0.98] overflow-hidden rounded-none"
            >
              ...
              <div className="relative z-10 flex items-center gap-6">
                <div className="w-14 h-14 bg-black/5 dark:bg-white/5 flex items-center justify-center rounded-none group-hover:bg-black dark:hover:bg-white group-hover:text-black transition-all duration-500">
            ...
            <div className="space-y-4">
              {recentRecharges.length > 0 ? (
                recentRecharges.map((reg) => (
                  <div key={reg.id} className="group flex items-center justify-between py-4 border-b border-black/5 dark:border-white/5 hover:border-black/10 dark:border-white/10 transition-colors">
                    <div className="flex items-center gap-4">
                      <div className="w-8 h-8 bg-black/5 dark:bg-white/5 flex items-center justify-center rounded-none group-hover:bg-gold-400 group-hover:text-black transition-all">
                        <Check size={14} />
                      </div>
                      <div>
                        <p className="text-[10px] font-black text-black dark:text-white uppercase tracking-widest leading-none mb-1">RECARGA_EXITOSA</p>
                        <p className="text-[7px] text-black/20 dark:text-white/20 uppercase tracking-widest font-bold">
        ...
        {(appStatus !== 'idle' || successMsg || inputMode === 'keyboard') && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-8 bg-black/95 backdrop-blur-3xl animate-fade-in">
              ...
              <div className="max-w-md w-full animate-enter-screen text-center space-y-16">
                <div className="space-y-4">
                  <div className="flex items-center justify-center gap-3 opacity-40">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-black dark:text-white">PROTOCOLO_MANUAL</span>
                  </div>
                  <h2 className="text-3xl font-black text-black dark:text-white uppercase tracking-tighter">INGRESE_CÓDIGO_PIN</h2>
                </div>
                ...
                <div className="relative">
                  <textarea 
                      ...
                      placeholder="•••• •••• ••••" 
                      className="w-full bg-transparent text-5xl md:text-6xl font-mono text-center tracking-[0.2em] text-black dark:text-white focus:outline-none placeholder:text-white/5 uppercase resize-none overflow-hidden break-all leading-tight font-black" 
                      onInput={(e) => {
                ...
                <div className="space-y-6">
                  <button 
                      ...
                      className="w-full py-8 bg-black dark:bg-white text-white dark:text-black font-black uppercase tracking-[0.6em] text-[13px] active:scale-95 disabled:opacity-10 shadow-[0_20px_40px_rgba(255,255,255,0.1)] transition-all"
                  >
                    VERIFICAR_IDENTIDAD
                  </button>
                  ...
                  <button 
                      ...
                      className="text-[11px] font-black text-black/20 dark:text-white/20 hover:text-black dark:hover:text-white uppercase tracking-[0.5em] transition-all"
                  >
                    CANCELAR_OPERACIÓN
                  </button>
                </div>
            ...
            {appStatus === 'loading' && (
              <div className="flex flex-col items-center justify-center gap-12 text-center">
                <div className="relative w-32 h-32">
                  <div className="absolute inset-0 border border-black/5 dark:border-white/5 rounded-full"></div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[9px] text-black/20 dark:text-white/20 uppercase tracking-[0.8em] font-bold">SINCRONIZANDO CON EL LIBRO MAYOR</p>
                </div>
              </div>
            )}

            {appStatus === 'success' && cardData && (
              <div className="max-w-md w-full bg-white dark:bg-[#050505] border border-black/10 dark:border-white/10 p-16 shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative animate-enter-screen text-center overflow-hidden">
                ...
                <div className="mb-16 relative z-10">
                  <p className="text-[10px] text-black/30 dark:text-white/30 uppercase tracking-[0.8em] mb-8 font-black">VALOR_ACREDITABLE</p>
                  <h2 className="text-8xl font-black text-black dark:text-white tracking-tighter leading-none font-mono">{Math.round(cardData.valor_punto).toLocaleString()}</h2>
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <button 
                    onClick={factoryReset} 
                    className="w-full py-4 text-black/20 dark:text-white/20 hover:text-black dark:hover:text-white text-[11px] font-black uppercase tracking-[0.5em] transition-all"
                  >
                    ABORTAR_OPERACIÓN
                  </button>
                </div>
            ...
            {appStatus === 'error' && (
              <div className="max-w-md w-full bg-white dark:bg-[#050505] border border-black/10 dark:border-white/10 p-16 text-center shadow-[0_50px_100px_rgba(0,0,0,0.8)] animate-enter-screen">
                ...
                <div className="mb-16">
                  ...
                  <p className="text-lg font-black text-black dark:text-white uppercase tracking-tight leading-tight">{errorMsg}</p>
                </div>
                <button 
                  onClick={factoryReset} 
                  className="w-full py-7 bg-black dark:bg-white text-white dark:text-black text-[12px] font-black uppercase tracking-[0.6em] active:scale-[0.95] shadow-2xl transition-all"
                >
                  REINTENTAR_CONEXIÓN
                </button>
              </div>
            ...
            {successMsg && (
              <div className="max-w-md w-full bg-white dark:bg-[#050505] border border-black/10 dark:border-white/10 p-20 text-center shadow-[0_80px_150px_rgba(0,0,0,0.9)] animate-enter-screen">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col items-center gap-4">
                      ...
                      <p className="text-[10px] text-black/20 dark:text-white/20 uppercase tracking-[1em] font-black ml-[1em]">BÓVEDA_ACTUALIZADA</p>
                  </div>
                </div>
              </div>
            )}
        ...
        {inputMode === 'camera' && appStatus === 'idle' && (
          <div className="fixed inset-0 z-[500] bg-white dark:bg-black flex flex-col items-center justify-center animate-fade-in overflow-hidden">
            <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 z-10 pointer-events-none" style={{ boxShadow: '0 0 0 100vmax rgba(0,0,0,0.95)' }}>
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 md:w-[450px] md:h-[450px] border border-black/5 dark:border-white/5">
                ...
                <div className="absolute top-20 left-0 right-0 text-center z-20 space-y-2">
                  ...
                  <p className="text-[8px] text-black/30 dark:text-white/30 uppercase tracking-[0.5em]">POSICIONE EL QR DENTRO DEL MARCO</p>
                </div>
            </div>
            
            <button 
              onClick={factoryReset} 
              className="absolute bottom-24 z-30 w-24 h-24 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-black dark:text-white flex items-center justify-center backdrop-blur-3xl rounded-full active:scale-90 shadow-2xl transition-all hover:bg-black/10 dark:bg-white/10"
            >
