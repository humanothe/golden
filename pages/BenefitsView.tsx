  ...
  return (
    <div className="min-h-screen bg-black text-white relative font-heading overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col overflow-y-auto no-scrollbar pb-32">
        <header className="max-w-[1400px] w-full mx-auto px-8 md:px-12 pt-16 md:pt-24 mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl md:text-9xl font-black tracking-tighter uppercase leading-[0.8] text-white">
          ...
          <button 
            ...
            className="group flex items-center gap-4 px-8 py-4 bg-white/[0.03] border border-white/10 rounded-full hover:bg-gold-400 hover:text-black transition-all active:scale-95"
          >
        ...
        <div className="max-w-[800px] w-full mx-auto px-6 md:px-12 space-y-8">
          ...
          {loading ? (
            <div className="py-40 flex flex-col items-center gap-10 bg-white/[0.02] border border-white/5 rounded-[3rem] backdrop-blur-xl">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-[9px] text-white/20 uppercase tracking-widest">Consultando Libro Mayor de Transacciones...</p>
              </div>
            </div>
          ) : networkError ? (
            <div className="py-32 text-center border border-red-500/10 bg-red-500/[0.02] p-12 rounded-[3rem] backdrop-blur-xl">
               ...
               <button onClick={handleManualRetry} className="w-full py-8 bg-white text-black font-black uppercase text-[12px] tracking-[0.6em] active:scale-95 transition-all shadow-2xl rounded-2xl">REINTENTAR_CONEXIÓN</button>
            </div>
          ) : !summary ? (
            <div className="py-40 text-center border border-dashed border-white/10 rounded-[3rem] opacity-40">
              ...
              <button onClick={() => window.location.reload()} className="mt-12 text-gold-400 text-[11px] font-black underline uppercase tracking-[0.6em] flex items-center gap-4 mx-auto hover:text-white transition-colors">
            ...
            <div className="space-y-10 animate-enter-screen">
              ...
              <div className="bg-white/[0.02] border border-white/10 p-8 md:p-16 relative overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.5)] rounded-[2.5rem] md:rounded-[3rem] backdrop-blur-3xl">
                  <div className="absolute -top-20 -right-20 p-8 opacity-[0.02] pointer-events-none">
                     <TrendingUp size={400} />
                  </div>
                  
                  <div className="flex justify-between items-center mb-12 md:mb-20 border-b border-white/5 pb-8 md:pb-12">
                     ...
                     <div className="text-right">
                        ...
                        <p className="text-[11px] md:text-[14px] font-mono text-white/60 font-bold tracking-[0.1em] md:tracking-[0.2em] uppercase">{new Date(summary.created_at).getTime().toString(36).toUpperCase()}</p>
                     </div>
                  </div>
                  ...
                  <div className="space-y-12 md:space-y-16">
                     <div>
                        ...
                        <h3 className="text-4xl md:text-8xl font-black text-white uppercase tracking-tighter leading-[0.9] break-words">{summary.nombre_negocio}</h3>
                     </div>

                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 py-8 md:py-12 border-y border-white/5">
                        ...
                        <div className="md:text-right space-y-2 md:space-y-4">
                           ...
                           <div className="flex items-center md:justify-end gap-3 md:gap-4 text-white">
              ...
              <div className="p-8 md:p-10 bg-white/[0.02] border border-white/5 rounded-[2rem] md:rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 backdrop-blur-xl">
                 <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-2xl md:text-4xl font-mono font-black text-white tracking-tighter">RD$ {user?.vault_balance.toLocaleString()}</p>
                    </div>
                 </div>
              ...
              <button 
                onClick={() => navigate('/dashboard')}
                className="w-full py-8 md:py-10 bg-white text-black font-black uppercase text-[12px] md:text-[14px] tracking-[0.6em] md:tracking-[0.8em] hover:bg-gold-400 transition-all active:scale-[0.98] shadow-[0_20px_80px_rgba(255,255,255,0.1)] flex items-center justify-center gap-4 md:gap-6 rounded-2xl md:rounded-3xl"
              >
